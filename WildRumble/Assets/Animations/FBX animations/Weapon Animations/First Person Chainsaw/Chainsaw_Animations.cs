...
public class Chainsaw_Animations : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            myAnimator.SetInteger("chainsawInt", Random.Range(0, 2));
            myAnimator.SetTrigger("chainsawIdle");
        }
    }
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire1") && Time.time > NextFire)
        {
            ...
            myAnimator.SetTrigger("chainsawShoot");
        ...
        {
            myAnimator.SetTrigger("chainsawUp");
        }
