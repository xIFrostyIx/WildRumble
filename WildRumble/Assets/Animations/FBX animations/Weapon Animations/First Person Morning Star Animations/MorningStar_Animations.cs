...
public class MorningStar_Animations : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            myAnimator.SetInteger("morningStarInt", Random.Range(0, 2));
            myAnimator.SetTrigger("morningStarIdle");
        }
    }
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire1") && Time.time > NextFire)
        {
            ...
            myAnimator.SetTrigger("morningStarShoot");
        ...
        {
            myAnimator.SetTrigger("morningStarUp");
        }
