...
public class EnemyAI_Kangaroo : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            myAnimator.SetInteger("kangarooIdle_Index", Random.Range(0, 3));
            myAnimator.SetTrigger("kangarooIdle");
        }
    }
    ...
    void Update()
    {
        ...
        if (distanceToPlayer < chaseRange)
        {
            ...
            if (distanceToPlayer > stoppingDistance)
            {
                ...
                myAnimator.SetBool("kangarooWalk", true);
                myAnimator.SetBool("kangarooAttack", false);
                myAnimator.SetBool("kangarooIdle_Bool", false);
            }
            else
            {
                navMeshAgent.SetDestination(transform.position); // Stop moving

                myAnimator.SetBool("kangarooAttack", true);
                myAnimator.SetBool("kangarooWalk", false);
                myAnimator.SetBool("kangarooIdle", false);
                myAnimator.SetBool("kangarooIdle_Bool", false);
            }
        }
        else
