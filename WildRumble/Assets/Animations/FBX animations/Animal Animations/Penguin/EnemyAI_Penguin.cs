...
public class EnemyAI_Penguin : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            myAnimator.SetInteger("penguinIdle_Index", Random.Range(0, 3));
            myAnimator.SetTrigger("penguinIdle");
        }
    }
    ...
    void Update()
    {
        ...
        if (distanceToPlayer < chaseRange)
        {
            ...
            if (distanceToPlayer > stoppingDistance)
            {
                ...
                myAnimator.SetBool("penguinWalk", true);
                myAnimator.SetBool("penguinAttack", false);
                myAnimator.SetBool("penguinIdle_Bool", false);
            }
            else
            {
                navMeshAgent.SetDestination(transform.position); // Stop moving

                myAnimator.SetBool("penguinAttack", true);
                myAnimator.SetBool("penguinWalk", false);
                myAnimator.SetBool("penguinIdle", false);
                myAnimator.SetBool("penguinIdle_Bool", false);
            }
        }
        else
