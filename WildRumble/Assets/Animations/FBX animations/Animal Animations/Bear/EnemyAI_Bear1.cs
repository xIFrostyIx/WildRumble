...
public class EnemyAI_Bear1 : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            myAnimator.SetInteger("bearIdle_Index1", Random.Range(0, 3));
            myAnimator.SetTrigger("bearIdle1");
        }
    }
    ...
    void Update()
    {
        ...
        myAnimator.SetFloat("Speed1", navMeshAgent.velocity.magnitude);
        ...
        if (distanceToPlayer < chaseRange)
        {
            ...
            if (distanceToPlayer > stoppingDistance)
            {
                ...
                myAnimator.SetBool("bearWalk1", true);
                myAnimator.SetBool("bearAttack1", false);
                myAnimator.SetBool("bearIdle_Bool1", false);
            }
            else
            {
                navMeshAgent.SetDestination(transform.position); // Stop moving

                myAnimator.SetBool("bearAttack1", true);
                myAnimator.SetBool("bearWalk1", false);
                myAnimator.SetBool("bearIdle_Bool1", false);
            }
        }
        else
