...
public class EnemyAI_Bear : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            myAnimator.SetInteger("bearIdle_Index", Random.Range(0, 3));
            myAnimator.SetTrigger("bearIdle");
        }
    }
    ...
    void Update()
    {
        ...
        if (distanceToPlayer < chaseRange)
        {
            ...
            if (distanceToPlayer > stoppingDistance)
            {
                ...
                myAnimator.SetBool("bearWalk", true);
                myAnimator.SetBool("bearAttack", false);
                myAnimator.SetBool("bearIdle_Bool", false);
            }
            else
            {
                navMeshAgent.SetDestination(transform.position); // Stop moving

                myAnimator.SetBool("bearAttack", true);
                myAnimator.SetBool("bearWalk", false);
                myAnimator.SetBool("bearIdle_Bool", false);
            }
        }
        else
