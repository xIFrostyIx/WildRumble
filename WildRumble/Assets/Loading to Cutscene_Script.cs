...
public class SceneLoader : MonoBehaviour
{
    ...
    public PlayableAsset cutsceneTimeline; // Reference to the Timeline (PlayableAsset)
    ...
    {
        // Check if the cutsceneDirector is assigned and the Timeline is set, then play the timeline
        if (cutsceneDirector != null && cutsceneTimeline != null)
        {
            cutsceneDirector.Play(cutsceneTimeline); // Start playing the cutscene Timeline
        }
    }
}